...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    ...
    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/slc6_amd64_gcc481/13TeV/madgraph/V5_2.3.0/SUSYGluGluToBBHToTauTau_M-500/v2/SUSYGluGluToBBHToTauTau_M-500_tarball.tar.xz')
)
