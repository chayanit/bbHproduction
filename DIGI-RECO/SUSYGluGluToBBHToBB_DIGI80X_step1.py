...
# with command line options: step1 --filein file:HIG-RunIISummer15wmLHEGS-01472.root --fileout file:HIG-RunIISummer16DR80Premix-03535_step1.root --pileup_input dbs:/Neutrino_E-10_gun/RunIISpring15PrePremix-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v2-v2/GEN-SIM-DIGI-RAW --mc --eventcontent PREMIXRAW --datatier GEN-SIM-RAW --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --step DIGIPREMIX_S2,DATAMIX,L1,DIGI2RAW,HLT:@frozen2016 --nThreads 4 --datamix PreMix --era Run2_2016 --python_filename SUSYGluGluToBBHToBB_DIGI80X_step1.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 360
...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(360)
)

# Input source
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/user/chayanit/MSSMHbb/SUSYGluGluToBBHToBB_M-350_cfg_GEN-SIM/170714_224614/0000/output_1.root'),
...
process.PREMIXRAWoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIISummer16DR80Premix-03535_step1.root'),
